...
export function AboutBlock({ content }: { content: any }) {
  if (!content || !content.hero) return null;

  return (
    <div className="min-h-screen bg-white text-slate-600 relative z-0 selection:bg-[#115E59] selection:text-white w-full">
