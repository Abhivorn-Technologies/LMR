    ...
    <div className="flex flex-col gap-16 font-sans selection:bg-[#115E59] selection:text-white pb-20 overflow-hidden">
      ...
      >
        <h2 className="text-3xl md:text-4xl font-bold text-[#04151a] mb-6">
          Buy/Renew Two Wheeler Insurance Policy <span className="text-[#115E59]">Online in India 2026</span>
        </h2>
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="lg:col-span-7 p-6 md:p-10 lg:p-12 rounded-[2rem] lg:rounded-[3rem] bg-white border border-slate-100 shadow-xl shadow-slate-200/40 relative overflow-hidden flex flex-col justify-between group">
          ...
          <div className="relative z-10">
            <div className="flex items-center gap-5 mb-6">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-[#04151a]">What is Two-Wheeler Insurance?</h2>
            </div>
          ...
          <div className="mt-8 p-6 bg-[#00B4D8]/5 border border-[#00B4D8]/20 rounded-2xl relative z-10 flex flex-col sm:flex-row gap-4 items-start sm:items-center">
            ...
            <p className="text-[#008ba8] font-medium leading-relaxed text-base">
              <strong className="text-[#00708a]">Smart Choice:</strong> While third-party (TP) insurance is mandatory by law, it’s wise to opt for comprehensive coverage for better protection.
            </p>
          </div>
        </motion.div>
      ...
      >
        <div className="text-center mb-10 lg:mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-[#04151a] mb-4">Types of Two-Wheeler Insurance Policies</h2>
              ...
              content: (
                <div className="space-y-4">
                  ...
                  <div className="mt-6 p-6 bg-[#115E59]/5 rounded-2xl border border-[#115E59]/10">
                    <h4 className="font-bold text-[#115E59] text-lg mb-3">Benefits of Comprehensive Insurance:</h4>
                    <ul className="space-y-2 text-slate-700 font-medium text-base">
                      <li className="flex items-center gap-3"><CheckCircle2 className="text-[#115E59] w-5 h-5"/> Complete protection against natural and man-made calamities.</li>
                      <li className="flex items-center gap-3"><CheckCircle2 className="text-[#115E59] w-5 h-5"/> Coverage for theft of your scooter or bike.</li>
                      <li className="flex items-center gap-3"><CheckCircle2 className="text-[#115E59] w-5 h-5"/> Extra protection with customized add-ons like zero depreciation.</li>
                    </ul>
                  </div>
                </div>
              )
      ...
      >
        <div className="text-center mb-10 lg:mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-[#04151a] mb-4">Key Features of LMB Two-Wheeler Insurance</h2>
          <p className="text-base md:text-lg text-slate-600 max-w-2xl mx-auto">
      ...
      >
        ...
        <div className="relative z-10 mb-10 lg:mb-16 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-4 text-[#04151a]">Different Types of Two-Wheelers We Cover</h2>
        ...
        <motion.div variants={staggerContainer} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 relative z-10 max-w-6xl mx-auto">
          {[
            ...
            <motion.div key={i} variants={fadeInUp} className="group flex flex-col items-center text-center p-6 lg:p-8 rounded-[1.5rem] lg:rounded-[2rem] bg-white border-2 border-slate-100 transition-all duration-500 shadow-sm shadow-slate-200/40 hover:-translate-y-2 hover:shadow-xl hover:shadow-[#115E59]/20 hover:border-[#115E59] cursor-pointer">
              ...
              <h4 className="text-[#04151a] group-hover:text-[#115E59] font-bold text-lg lg:text-xl mb-3 transition-colors duration-500">{bike.title}</h4>
