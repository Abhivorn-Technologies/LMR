    ...
    <div className="flex flex-col gap-16 font-sans selection:bg-[#2563EB] selection:text-white pb-20 overflow-hidden">
      ...
      >
        <h2 className="text-3xl md:text-4xl font-bold text-[#0F172A] mb-6">
          Comprehensive Business <span className="text-[#2563EB]">Insurance Solutions</span>
        </h2>
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="lg:col-span-7 p-6 md:p-10 lg:p-12 rounded-[2rem] lg:rounded-[3rem] bg-white border border-slate-100 shadow-xl shadow-slate-200/40 relative overflow-hidden flex flex-col justify-between group">
          ...
          <div className="relative z-10">
            <div className="flex items-center gap-5 mb-6">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-[#0F172A]">Workmen Compensation Insurance</h2>
            </div>
          ...
          <div className="mt-8 p-6 bg-[#F97316]/5 border border-[#F97316]/20 rounded-2xl relative z-10 flex flex-col sm:flex-row gap-4 items-start sm:items-center">
            ...
            <p className="text-[#EA580C] font-medium leading-relaxed text-base">
              <strong className="text-[#C2410C]">Mandatory Requirement:</strong> It is mandatory for employers (especially manufacturing units) with more than 20 employees as per the Employees' State Insurance Act, 1948.
            </p>
          </div>
        </motion.div>
      ...
      >
        <div className="text-center mb-10 lg:mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-[#0F172A] mb-4">LMB's Core Business Insurance Plans</h2>
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid md:grid-cols-2 gap-4 mt-6">
                    ...
                    <div className="p-6 bg-orange-50 rounded-2xl border border-orange-100">
                      <h4 className="font-bold text-orange-700 text-lg mb-3 flex items-center gap-2"><ShieldAlert size={20}/> Exclusions:</h4>
                      <ul className="space-y-2 text-slate-600 font-medium text-base">
              ...
              content: (
                <div className="space-y-4">
                  ...
                  <div className="mt-6 p-6 bg-[#2563EB]/5 rounded-2xl border border-[#2563EB]/10">
                    <h4 className="font-bold text-[#2563EB] text-lg mb-3">Key Coverages:</h4>
                    <ul className="space-y-2 text-slate-700 font-medium text-base">
                      <li className="flex items-center gap-3"><CheckCircle2 className="text-[#2563EB] w-5 h-5"/> <strong>Material Damage:</strong> Covers clearance & debris removal costs.</li>
                      <li className="flex items-center gap-3"><CheckCircle2 className="text-[#2563EB] w-5 h-5"/> <strong>Third-Party Liability:</strong> Protects against legal claims for property damage or injury.</li>
                      <li className="flex items-center gap-3"><CheckCircle2 className="text-[#2563EB] w-5 h-5"/> <strong>Comprehensive Cover:</strong> For projects where civil works exceed 50% of value.</li>
                    </ul>
                  </div>
              ...
              content: (
                <div className="space-y-4">
                  ...
                  <div className="mt-6 p-6 bg-[#F97316]/5 rounded-2xl border border-[#F97316]/10">
                    <h4 className="font-bold text-[#EA580C] text-lg mb-3">Coverage Details:</h4>
                    <ul className="space-y-2 text-slate-700 font-medium text-base">
                      <li className="flex items-start gap-3">
                        <CheckCircle2 className="text-[#EA580C] w-5 h-5 mt-0.5 flex-shrink-0"/> 
      ...
      >
        <div className="text-center mb-10 lg:mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-[#0F172A] mb-4">How are LMB Business Premiums Calculated?</h2>
          <p className="text-base md:text-lg text-slate-600 max-w-2xl mx-auto">
      ...
      >
        ...
        <div className="relative z-10 mb-10 lg:mb-16 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-4 text-[#0F172A]">Who Needs These Policies?</h2>
        ...
        <motion.div variants={staggerContainer} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 relative z-10 max-w-6xl mx-auto">
          {[
            ...
            <motion.div key={i} variants={fadeInUp} className="group flex flex-col items-center text-center p-6 lg:p-8 rounded-[1.5rem] lg:rounded-[2rem] bg-white border-2 border-slate-100 transition-all duration-500 shadow-sm shadow-slate-200/40 hover:-translate-y-2 hover:shadow-xl hover:shadow-[#2563EB]/20 hover:border-[#2563EB] cursor-pointer">
              ...
              <h4 className="text-[#0F172A] group-hover:text-[#2563EB] font-bold text-lg lg:text-xl mb-3 transition-colors duration-500">{item.title}</h4>
