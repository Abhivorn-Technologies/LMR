...
import { Shield, Mail, Lock, AlertCircle, CheckCircle2, ArrowRight, Eye, EyeOff } from 'lucide-react';
      ...
      <div className="max-w-[420px] w-full mx-4 relative z-10">
        ...
        <div className="bg-white/80 backdrop-blur-xl p-10 rounded-[2rem] shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-white/50">
          ...
          <div className="text-center mb-10">
            ...
            <h1 className="text-2xl font-bold text-slate-800 tracking-tight">Admin Setup</h1>
            <p className="text-slate-500 mt-2 text-sm font-medium">Create your master CMS credentials</p>
          </div>
          ...
          {success && (
            <div className="bg-emerald-50 border border-emerald-100 text-emerald-600 p-4 rounded-xl mb-6 flex items-start text-sm">
          ...
          <div className="mt-8 text-center pt-6 border-t border-slate-100">
            <p className="text-sm text-slate-500">
              ...
              <Link href="/login" className="font-semibold text-cyan-600 hover:text-cyan-500 transition-colors">
                Log in here
              </Link>
            </p>
          </div>
